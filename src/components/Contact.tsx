...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      ref={sectionRef}
      className={`relative z-30 m-0 flex min-h-screen flex-col items-center justify-center gap-8 bg-linear-to-br from-gray-100 to-gray-50 p-4 text-center sm:gap-10 sm:p-6 ${
        ...
        <div className="mb-8 flex flex-col gap-4 sm:gap-6">
          <div className="flex flex-col items-center gap-3 sm:flex-row">
            ...
            <button
              ...
              className="group flex items-center justify-center gap-2 rounded-xl border-2 border-gray-300 bg-white px-6 py-4 text-gray-700 transition-all duration-300 hover:scale-105 hover:border-gray-700 hover:bg-gray-50"
          ...
          <a
            href="/resume.pdf"
            download
            className="group flex items-center justify-center gap-3 rounded-xl border-2 border-gray-700 bg-gray-100 px-8 py-4 text-gray-700 transition-all duration-300 hover:scale-105 hover:bg-gray-700 hover:text-white hover:shadow-xl"
          >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              className="group flex items-center justify-center gap-2 rounded-xl border-2 border-gray-300 bg-white px-6 py-3 text-gray-700 transition-all duration-300 hover:scale-105 hover:border-gray-700 hover:bg-gray-50"
            >
